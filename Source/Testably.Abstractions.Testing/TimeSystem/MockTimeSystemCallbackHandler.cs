...
internal sealed class MockTimeSystemCallbackHandler : ICallbackHandler
{
	...
	/// <inheritdoc cref="ICallbackHandler.DateTimeRead(Action{DateTime}?, Func{DateTime, bool}?)" />
	...
	/// <inheritdoc cref="ICallbackHandler.TaskDelay(Action{TimeSpan}?, Func{TimeSpan, bool}?)" />
	...
	/// <inheritdoc cref="ICallbackHandler.ThreadSleep(Action{TimeSpan}?, Func{TimeSpan, bool}?)" />

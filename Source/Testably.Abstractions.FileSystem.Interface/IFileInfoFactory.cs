...
public interface IFileInfoFactory : IFileSystemEntity
{
	...
	/// <summary>
	///     Wraps the <paramref name="fileInfo" /> in a wrapper for <see cref="FileInfo" /> which implements
	///     <see cref="IFileInfo" />.
	/// </summary>
...
{
	/// <summary>
	///     Backwards-compatibility alias for <see cref="Testably.Abstractions.IFileInfoFactory" />.
	/// </summary>
	public interface IFileInfoFactory : Testably.Abstractions.IFileInfoFactory
	{
	}
}
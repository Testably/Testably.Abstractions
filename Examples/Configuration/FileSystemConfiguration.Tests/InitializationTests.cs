...
public class InitializationTests
{
	...
	public void InitializeFileSystemWithUncDrive()
	{
		...
		fileSystem.DriveInfo.GetDrives().Should().HaveCount(1);
		var drive = fileSystem.DriveInfo.New(@"//unc-server");
	...
	{
		MockFileSystem fileSystem = new();
		var random = fileSystem.RandomSystem.Random.Shared;
		var firstFileContent = new byte[199];
		var secondFileContent = new byte[2];
		...
		var mainDrive = fileSystem.DriveInfo.GetDrives().Single();

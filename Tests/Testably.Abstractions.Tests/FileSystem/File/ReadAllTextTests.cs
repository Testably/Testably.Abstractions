...
[FileSystemTests]
public class ReadAllTextTests(FileSystemTestData testData) : FileSystemTestBase(testData)
{
	[Test]
	[AutoArguments]
	...
	[Test]
	[MethodDataSource(typeof(TestData), nameof(TestData.GetEncodingsForReadAllText))]

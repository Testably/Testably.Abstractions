...
namespace Testably.Abstractions.Tests.FileSystem.DirectoryInfo.EnumerateFiles;

// ReSharper disable once PartialTypeWithSinglePart
public abstract partial class DirectoryInfoEnumerateFilesTests<TFileSystem>

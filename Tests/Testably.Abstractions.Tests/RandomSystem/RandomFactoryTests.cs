	...
	where TRandomSystem : IRandomSystem
{
	...
	[SkippableFact]
	public void Shared_ShouldReturnSameObject()
	{
		IRandom random1 = RandomSystem.Random.Shared;
		IRandom random2 = RandomSystem.Random.Shared;

		random1.Should().BeSameAs(random2);
	}
}
